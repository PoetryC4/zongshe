...
public class ChangePhoneVerify extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!userId.isEmpty()) {
            try {
                ...
                if (res.getCode() == 0) {
                    Toast.makeText(ChangePhoneVerify.this, res.getMsg(), Toast.LENGTH_LONG).show();
                } else {
    ...
    private void changeMode(boolean isDark) {
        ...
        if (isDark) {
            findViewById(R.id.phoneVerify_body).setBackgroundColor(colors.colorSuperGray);
            findViewById(R.id.phoneVerify_line).setBackgroundColor(colors.colorWhite);
            ...
            findViewById(R.id.phoneVerify_body).setBackgroundColor(colors.colorWhite);
            findViewById(R.id.phoneVerify_line).setBackgroundColor(colors.colorGray);
            ...
            public void onClick(View view) {
                ...
                if (!isEmailValid) {
                    ...
                    if (email_verify_code != -1 && Integer.parseInt(et_code.getText().toString()) == email_verify_code) {
                        ...
                        intent.setClass(ChangePhoneVerify.this, ChangePhone.class);
